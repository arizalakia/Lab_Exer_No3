...
public class listschools extends AppCompatActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_listschools);
    ...
    public void previousPage(View view) {
        Intent intent = new Intent(listschools.this, MainActivity.class);
