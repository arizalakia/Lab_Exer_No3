package com.example.lab_exer_no3;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schl6 = findViewById(R.id.ed_schl6);
        schl7 = findViewById(R.id.ed_schl7);
        schl8 = findViewById(R.id.ed_schl8);
    }
    ...
    public void nextPage(View view) {
        Intent intent = new Intent(MainActivity.this, listschools.class);
